        ...
        Column(
            ...
            Row(modifier = Modifier
                ...
                FloatingActionButton(
                    ...
                    Image(
                        painter = painterResource(id = R.drawable.ic_baseline_refresh_24), contentDescription = "reset")
                }
                ...
                FloatingActionButton(
                    ...
                    Image(
                        painter = painterResource(id = if(isRunning) R.drawable.ic_baseline_pause_24 else R.drawable.ic_baseline_play_arrow_24), contentDescription = "start/pause")
                }
